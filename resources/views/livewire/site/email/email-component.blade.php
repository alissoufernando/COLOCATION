        ...
        <tr>
          <td>
            <table align="left" border="0" cellpadding="0" cellspacing="0" style="text-align: left;" width="100%">
              <tbody>
                <tr>
                  <td style="text-align: center;"><img src="../../assets/images/email-template/delivery-2.png" alt="" style=";margin-bottom: 30px;"></td>
                </tr>
                <tr>
                  <td>
            ...
            <table cellpadding="0" cellspacing="0" border="0" align="left" style="width: 100%;margin-top: 10px;    margin-bottom: 10px;">
              <tbody>
                <tr>
                  ...
                  <td><img src="../../assets/images/email-template/space.jpg" alt=" " height="25" width="30"></td>
                  <td style="background-color: #fafafa;border: 1px solid #ddd;padding: 15px;letter-spacing: 0.3px;width: 50%;">
        ...
        <tr>
          <td style="padding: 30px;">
            ...
            <table class="footer-social-icon" border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top:20px;">
              <tbody>
                <tr>
                  <td><a href="ecommerce-templates.html#"><img src="../../assets/images/email-template/facebook.png" alt=""></a></td>
                  <td><a href="ecommerce-templates.html#"><img src="../../assets/images/email-template/youtube.png" alt=""></a></td>
                  <td><a href="ecommerce-templates.html#"><img src="../../assets/images/email-template/twitter.png" alt=""></a></td>
                  <td><a href="ecommerce-templates.html#"><img src="../../assets/images/email-template/gplus.png" alt=""></a></td>
                  <td><a href="ecommerce-templates.html#"><img src="../../assets/images/email-template/linkedin.png" alt=""></a></td>
                  <td><a href="ecommerce-templates.html#"><img src="../../assets/images/email-template/pinterest.png" alt=""></a></td>
                </tr>
              </tbody>
            </table>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px auto 0;">
              <tbody>
                <tr>
                  <td><a href="ecommerce-templates.html#" style="font-size:13px">Want to change how you receive these emails?</a></td>
                </tr>
                <tr>
                  <td>
                ...
                <tr>
                  <td><a href="ecommerce-templates.html#" style="font-size:13px; margin:0;text-decoration: underline;">Unsubscribe</a></td>
                </tr>
              </tbody>
            </table>
          </td>
