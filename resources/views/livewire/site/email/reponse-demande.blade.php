															...
															<td class="pad"
																...
																<div align="center" class="alignment"
																	style="line-height:10px"><img alt="Yourlogo Light"
																		src="{{asset('assets/site/assets/images/logo_sb_1.png')}}"
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																...
																<div align="center" class="alignment"
																	style="line-height:10px"><img alt="Check Icon"
																		src="{{ asset('assets/images/check-icon.png') }}"
																		{{-- style="display: block; height: auto; border: 0; width: 93px; max-width: 100%;" --}}
																		title="Check Icon" width="100" height="100" /></div>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
																...
																<div
																	...
																	<div class=""
																		...
																		<p
																			...
																			<span style="font-size:42px;">Demande acceptée</span></p>
																	</div>
																</div>
															</td>
														</tr>
																...
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			...
																			<span style="font-size:16px;">Salut
																				<strong><u>{{$mydemande->user->name}}</u></strong>,</span></p>
																		<p
																		...
																		<p
																			style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;">
																			<span style="font-size:16px;">Votre demande pour rentrer en contact avec l'auteur de l'annonce <a href="{{route('site.detail-produit', ['id' => $mydemande->product->id])}}">{{ $mydemande->product->name }}</a> à été acceptée</span></p>
																		<p
																			style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;">
																			<span style="font-size:16px;">Type de chambre: {{ $mydemande->product->categorie->name }}</span>
																		</p>
                                                                        <p
																			style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;">
																			<span style="font-size:16px;">Nom de l'auteur de l'annonce: {{ $mydemande->product->user->name }}</span>
																		</p>
                                                                        <p
																			style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;">
                                                                            <span style="font-size:16px;">Type de l'annonce: {{ $mydemande->product->type_annonce }}</span>

																		</p>
                                                                        <p
																			style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;">
                                                                            <span style="font-size:16px;">Departement de l'annonce: {{ $mydemande->product->ville->departement->name  }}</span>

																		</p>
                                                                        <p
																			style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;">
                                                                            <span style="font-size:16px;">Ville de l'annonce: {{ $mydemande->product->ville->name  }}</span>

																		</p>
                                                                        <p
                                                                        style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;">
                                                                        <span style="font-size:16px;">Quantier de l'annonce: {{ $mydemande->product->quartier  }}</span>
																		...
																		<p
																			style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;">
																			<span
																				style="color:#000000;font-size:14px;"><a href="{{route('contact.par-message',['id' => $mydemande->product->user->id ])}}">Contacter</a></span></p>
																	</div>
																</div>
															</td>
														</tr>
																...
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			...
																			<span style="font-size:12px;">Your Street
																				12, 34567 AB City</span></p>
																		<p
																			style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">
																			<span
																				style="font-size:12px;">info@example.com
																			</span></p>
																		<p
																			style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">
																			<span style="font-size:12px;">(+1) 123 456
																				789</span></p>
																	</div>
																</div>
															</td>
																	...
																	<div class=""
																		...
																		<p
																			...
																			<span style="font-size:12px;">2021 © All
																				Rights Reserved by Student-coloc</span></p>
																	</div>
																</div>
															</td>
														</tr>
