    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <a href="tel:+22955221080" class="btn btn-fill-out btn-radius btn-sm"><i class="icon-basket-loaded"></i>
                Appeler</a>
                <a href="https://wa.me/+22955221080?text=Bonjour," class="btn btn-fill-out btn-radius btn-sm"><i class="icon-basket-loaded"></i>
                    Wthatsapp</a>
                    <a href="mailto:alissouanani@gmail.com" class="btn btn-fill-out btn-radius btn-sm"><i class="icon-basket-loaded"></i>
                        Mail</a>
        </div>
        @else
        <h1>Désolé</h1>
