                	...
                	<table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="product-stock-status" data-title="Stock Status"><span class="badge badge-pill badge-success">@if ($product->disponibilite == 0)
                                    Non
                                @else
                                    Oui
                                @endif</span></td>
                                <td class="product-add-to-cart"><a href="#" class="btn btn-fill-out btn-radius btn-sm "><i class="icon-basket-loaded"></i> Move to Cart</a></td>
