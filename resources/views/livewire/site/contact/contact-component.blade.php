            ...
            <div class="col-xl-4 col-md-6">
            	<div class="contact_wrap contact_style3">
                    ...
                    <div class="contact_text">
                        <span>Address</span>
                        <p>IITA,Rue avant la dépanneuse Lot 147-d</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
            	<div class="contact_wrap contact_style3">
                    ...
                    <div class="contact_text">
                        ...
                        <a href="mailto:alissouanani@gmail.com">alissouanani@gmail.com </a>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
            	<div class="contact_wrap contact_style3">
                    ...
                    <div class="contact_text">
                        <span>Phone</span>
                        <a href="https://wa.me/+22995185044?text=Bonjour,">+229 95185044</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form wire:submit.prevent="sendMessage">
                        <div class="row">
                            <div class="form-group col-md-6 mb-3">
                                <input required placeholder="Entrer votre nom *" id="first-name" class="form-control" name="name" type="text" wire:model="name">
                                @error('name')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
                             </div>
                            <div class="form-group col-md-6 mb-3">
                                <input required placeholder="Entrer votre Email *" id="email" class="form-control" name="email" type="email" wire:model="email">
                                @error('email')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
                            </div>
                            <div class="form-group col-md-6 mb-3">
                                <input required placeholder="Entrer votre numéro *" id="phone" class="form-control" name="phone" wire:model="phone">
                                @error('phone')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
                            </div>
                            <div class="form-group col-md-6 mb-3">
                                <input required placeholder="Entrer votre objet *" id="subject" class="form-control" name="subject" wire:model="subject">
                                @error('subject')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
