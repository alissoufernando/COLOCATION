              ...
              <div class="card-body p-0">
                <div class="row chat-box">
                  ...
                  <div class="col pr-0 chat-right-aside">
                    ...
                    <div class="chat">
                      @if ($userM == null)
                      <img class="rounded-circle" src="../assets/images/user/3.png" alt="">
                      @else
                        <!-- chat-header start-->
                        ...
                        <ul>
                            ...
                            <li class="clearfix">
                                <div class="message other-message pull-right">
                                    @empty(Auth::user()->image_user->path)
                                    <img class="rounded-circle float-right chat-user-img img-30" src="{{ asset('assets/images/user/1.png') }}" alt="">
                                    @else
                            ...
                            <div class="row">
                              <div class="col-xl-12 d-flex">
                                ...
                                <div class="input-group text-box">
                                  <input class="form-control input-txt-bx" id="message-to-send" type="text" name="message-to-send" placeholder="Type a message......" wire:model="message" required>
