                ...
                <div class="row chat-box">
                            ...
                            <div class="row">
                              <div class="col-xl-12 d-flex">
                                ...
                                <div class="input-group text-box">
                                  <input class="form-control input-txt-bx" id="message-to-send" type="text" name="message-to-send" placeholder="Type a message......" wire:model="message">
                  ...
                  {{-- <div class="col pl-0 chat-menu">
                    <ul class="nav nav-tabs nav-material nav-primary" id="info-tab" role="tablist">
                      <li class="nav-item"><a class="nav-link active" id="info-home-tab" data-toggle="tab" href="chat.html#info-home" role="tab" aria-selected="true">CALL</a>
                        <div class="material-border"></div>
                      </li>
                      <li class="nav-item"><a class="nav-link" id="profile-info-tab" data-toggle="tab" href="chat.html#info-profile" role="tab" aria-selected="false">STATUS</a>
                        <div class="material-border"></div>
                      </li>
                      <li class="nav-item"><a class="nav-link" id="contact-info-tab" data-toggle="tab" href="chat.html#info-contact" role="tab" aria-selected="false">PROFILE</a>
                        <div class="material-border"></div>
                      </li>
                    </ul>
                          ...
                          <div class="user-content text-center">
                            ...
                            <div class="social-media">
                              <ul class="list-inline">
                                <li class="list-inline-item"><a href="chat.html#"><i class="fa fa-facebook"></i></a></li>
                                <li class="list-inline-item"><a href="chat.html#"><i class="fa fa-google-plus"></i></a></li>
                                <li class="list-inline-item"><a href="chat.html#"><i class="fa fa-twitter"></i></a></li>
                                <li class="list-inline-item"><a href="chat.html#"><i class="fa fa-instagram"></i></a></li>
                                <li class="list-inline-item"><a href="chat.html#"><i class="fa fa-rss"></i></a></li>
                              </ul>
                            </div>
                            <hr>
