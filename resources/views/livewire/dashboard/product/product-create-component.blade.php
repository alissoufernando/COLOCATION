    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
            ...
            <a href="{{route('admin.product-index')}}" class="btn  btn-primary btn-sm float-end">Mes annonces</a>
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" id="ville" type="text" placeholder="la ville de l'annonce" wire:model="ville">
                          </div>
                          <div class="col-md-6 mb-3">
