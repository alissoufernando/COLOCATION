                    ...
                    <div>
                        <table width="80%">
                            <tbody>
                                ...
                                <tr>
                                    <td>Availability :</td>
                                    <td class="in-stock">@if ($product->disponibilite == 0)
                                        Non
                                    @else
                                        Oui
                                    @endif</td>
                    ...
                    <div class="tab-content" id="top-tabContent">
                        ...
                        <div class="tab-pane fade" id="top-contact" role="tabpanel" aria-labelledby="contact-top-tab">
                            <ul>
                                ...
                                <li>Disponibilité : @if ($product->disponibilite == 0)
                                        Non
                                    @else
                                        Oui
                                    @endif
                                </li>
                                <li>Department : {{ $product->departement }}</li>
                                <li>Commune : {{ $product->commune }}</li>

                                <li>Nombr de place : {{ $product->place_dispo }}</li>
